...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //edited
    public void INSERT_INTO_BMI_TABLE(String name, String age, String sex, float height, float weight, double bmi_result) {
        db = this.getWritableDatabase();

        ContentValues contentValues = new ContentValues();
        contentValues.put(CULOMN_NAME, name);
    ...
    public InfoModel GET_DATA(int id) {
        ...
        InfoModel model = new InfoModel(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3),  String.valueOf(cursor.getInt(4)),
                String.valueOf(cursor.getInt(5)), String.valueOf(cursor.getDouble(6)));
