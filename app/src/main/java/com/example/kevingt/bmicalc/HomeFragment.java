...
public class HomeFragment extends Fragment  {
    ...
    private String userWeight,userHeight,userAge,userSex,summary,userName;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ivv= (ImageView) view.findViewById(R.id.logoz);
        ...
        if (new PrefManager(getContext()).isFirstTime_home() == false) {
            ...
            userName=pref_Age_Sex.getString(AgeFragment.USER_NAME_EDITOR,"");
            ...
            set_result(userName,userAge,userSex,userHeight,userWeight);
    ...
    public void set_result(String userName, String userAge,String userSex, String userHeight,String userWeight){
        ...
        databaseHelper.INSERT_INTO_BMI_TABLE(userName,userAge,userSex,Float.parseFloat(userHeight)
                ,Float.parseFloat(userWeight),bmi);
    ...
    public void BMI_CLASSIFY(double bmi){
        ...
        if (bmi < 18.5) {
            ...
            ivv.setImageResource(R.drawable.underweight);
            ...
            ivv.setImageResource(R.drawable.healthy);
           ...
           // normalweightTxt.setTextColor(Color.GREEN);
            ...
            ivv.setImageResource(R.drawable.overweight);
            ...
            ivv.setImageResource(R.drawable.obese);
